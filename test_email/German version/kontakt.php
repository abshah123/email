   ...
   document.getElementsByTagName("BODY")[0].className += " safari";
			...
			<div class="row">
				...
				<div class="col-sm-4 <?php if ($fehler["name"] != "") { echo 'error'; } ?>">
					...
					<input <?php if($cfg['HTML5_FEHLERMELDUNGEN']) { ?> required style="box-shadow: 0 0 1px rgba(0,0,0, .4);" <?php }else{ ?> onchange="checkField(this)" <?php } ?> type="text" name="name" class="field" placeholder="Name *" value="<?php echo $_POST[name]; ?>" maxlength="<?php echo $zeichenlaenge_name; ?>" id="border-right"/>
			...
			<div class="row">
				<div class="col-sm-8 <?php if ($fehler["nachricht"] != "") { echo 'error'; } ?>">
					...
					<textarea <?php if($cfg['HTML5_FEHLERMELDUNGEN']) { ?> required <?php }else{ ?> onchange="checkField(this)" <?php } ?> aria-label="Nachricht" name="nachricht" class="field" rows="5" placeholder="Nachricht *" style="box-shadow: 0 0 1px rgba(0,0,0, .4);height:100%;width:100%;" id="border-right3"><?php echo $_POST[nachricht]; ?></textarea>
...
<hr style="height:0.10rem; border:none; color:#DADADA; background-color:#DADADA; margin-top:40px; margin-bottom:35px;" />
			...
			<div class="row" id="send">
				<div class="col-sm-8">
					...
					<br />
					<br />
					<input type="submit" class="senden" name="en-us-kf-km" value="Senden"  />
